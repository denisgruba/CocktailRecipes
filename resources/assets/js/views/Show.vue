            ...
            <div class="card">
                <div class="card-content">
                    ...
                    <div class="card-action">
                        <a v-if="this.favouritesID.includes(drink.idDrink)" @click="removeFavourite(drink.idDrink)" class="cursor-pointer">Remove Favourite</a>
                        <a v-else="this.favouritesID.includes(drink.idDrink)" @click="addFavourite(drink.idDrink)" class="cursor-pointer">Add Favourite</a>
                    </div>
                </div>
            </div>
